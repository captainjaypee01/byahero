<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav d-md-down-none">
            ...
            <li class="nav-item">
                <a href="{{ route('frontend.index') }}" class="nav-link">About Us</a>
            </li>
            <li class="nav-item">
                <a href="{{ route('frontend.promo') }}" class="nav-link">Travel Promos</a>
            </li>
            <li class="nav-item">
                <a href="{{ route('frontend.index') }}" class="nav-link">Travel Packages</a>
            </li>
            <li class="nav-item">
                <a href="{{route('frontend.contact')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.contact')) }}">@lang('navs.frontend.contact')</a>
            </li>
        </ul>

            
        <ul class="navbar-nav ml-auto d-md-down-none">
